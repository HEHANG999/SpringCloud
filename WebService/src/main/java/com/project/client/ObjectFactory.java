 ...
 * generated in the com.project.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Send_QNAME = new QName("http://impl.service.project.com/", "send");
    private final static QName _SendResponse_QNAME = new QName("http://impl.service.project.com/", "sendResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.project.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.project.com/", name = "send")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.project.com/", name = "sendResponse")
